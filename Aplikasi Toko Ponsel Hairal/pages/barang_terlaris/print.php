...
$pageTitle = 'Barang Terlaris per Bulan';
...
$raw  = $pdo->query("SHOW COLUMNS FROM vw_barang_terlaris")->fetchAll(PDO::FETCH_COLUMN);
$cols = [];
foreach ($raw as $c) $cols[$c] = labelize($c);

// Tambahan label kolom dari join
...
if (!in_array($sort, $allowedSort)) $sort = 'v.periode_date';
